...
models_dir <- "/home/bhaddock/repos/bnAb_pnlme/single_mabs/4PL_pure_rlu_v2/model_files"
...
run_one_model <- function(model_name, models_dir) {
  ...
  mlxtran_path <- file.path(models_dir, paste0("4PL_", model_name, ".mlxtran"))
