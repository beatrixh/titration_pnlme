...
models_dir <- "/home/bhaddock/repos/titration_pnlme/single_mabs/4PL_plate_fit_33_plates/v8/m5b/model_files"
...
# Top 20 4PL_plate_fit_small_data v8 models by BICc, regenerated from the corrected
# m0.mlxtran template + edited model_tracker.xlsx (see combined_likelihood_report_4PL_5PL.csv)
